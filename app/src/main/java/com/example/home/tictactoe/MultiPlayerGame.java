...
public class MultiPlayerGame extends AppCompatActivity implements View.OnClickListener
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.multi_player_game);
    ...
    {
        startActivity(new Intent(MultiPlayerGame.this,SplashActivity.class));
        finish();
    }
    ...
    {
        mediaPlayer = MediaPlayer.create(MultiPlayerGame.this,R.raw.draw);
        mediaPlayer.start();
    }
    ...
    {
        mediaPlayer = MediaPlayer.create(MultiPlayerGame.this,R.raw.snd_win);
        mediaPlayer.start();
    }
