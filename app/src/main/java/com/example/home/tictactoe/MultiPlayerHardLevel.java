...
public class MultiPlayerHardLevel extends AppCompatActivity implements View.OnClickListener
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multi_player_hard_level);
...
//            }
        ...
        if (field[0][5].equals(field[1][4])
                ...
                && field[0][5].equals(field[4][1])
                && field[0][5].equals(field[5][0])
                && !field[0][3].equals("")) {
...
//            }
    ...
    {
        startActivity(new Intent(MultiPlayerHardLevel.this,SplashActivity.class));
        finish();
    }
    ...
    {
        mediaPlayer = MediaPlayer.create(MultiPlayerHardLevel.this,R.raw.draw);
        mediaPlayer.start();
    }
    ...
    {
        mediaPlayer = MediaPlayer.create(MultiPlayerHardLevel.this,R.raw.snd_win);
        mediaPlayer.start();
    }
